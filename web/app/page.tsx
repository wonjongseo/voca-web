...
export default function Home() {
  ...
  const [multiCategorySearch,setMultiCategorySearch] = useState('');
  const [studyCategoryPresets,setStudyCategoryPresets] = useState<Record<string,string[]>>({});
  const [studyPresetName,setStudyPresetName] = useState('');
