...
const aliases: Record<string,string> = {'영단어':'word','단어':'word','의미':'meaning','뜻':'meaning','예시':'example','예문':'example','예시 뜻':'translation','예문 뜻':'translation','유의어':'synonyms','메모':'memo','즐겨찾기':'favorite'};
